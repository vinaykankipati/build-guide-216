   ...
   **Error excerpt**
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         qsc-cli chip-software download --workspace-path '/local/mnt/workspace/<userid>/K2L/QSC_CLI_BUILD/build' --product 'QCM6490.LE.2.0' --release 'r00270.1' --distribution 'Qualcomm_Linux.SPF.2.0|TEST|DEVICE|PUBLIC'
